package com.djx.yunpicturebackend.manager.auth;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.djx.yunpicturebackend.manager.auth.model.SpaceUserAuthConfig;
import com.djx.yunpicturebackend.manager.auth.model.SpaceUserPermissionConstant;
import com.djx.yunpicturebackend.manager.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    public List<String> getPermissionsByRole(String spaceUserRole) {
        ...
        SpaceUserRole role = SPACE_USER_AUTH_CONFIG.getRoles()
                .stream()
                .filter(r -> r.getName().equals(spaceUserRole))
                .findFirst()
                .orElse(null);
        if (role == null) {
            return new ArrayList<>();
