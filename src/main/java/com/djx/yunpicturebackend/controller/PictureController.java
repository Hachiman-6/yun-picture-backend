...
import com.djx.yunpicturebackend.api.aliyunai.AliYunAiApi;
import com.djx.yunpicturebackend.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.djx.yunpicturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
...
import com.djx.yunpicturebackend.manager.auth.annotation.SaSpaceCheckPermission;
...
import com.djx.yunpicturebackend.model.vo.PictureTagCategory;
...
//            ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR, "访问空间不存在");
//            User loginUser = userService.getLoginUser(request);
//            if (!loginUser.getId().equals(space.getUserId())) {
//                throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "访问空间没有权限");
//            }
        }
        // 查询数据库
        Page<Picture> picturePage = pictureService.page(new Page<>(current, size),
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        ThrowUtils.throwIf(pictureQueryRequest.getSpaceId() != null, ErrorCode.OPERATION_ERROR, "非公共图库不需要缓存");
        long current = pictureQueryRequest.getCurrent();
        long size = pictureQueryRequest.getPageSize();
        // 限制爬虫
        ThrowUtils.throwIf(size > 20, ErrorCode.PARAMS_ERROR);
        ...
        // 2.如果本地缓存未命中，操作 Redis，从分布式缓存中查询
